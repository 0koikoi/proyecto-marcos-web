...
public class GlobalExceptionHandler {
    ...
    public String handleDataIntegrityViolation(DataIntegrityViolationException ex, Model model) {
        // Podría ser un duplicado de un valor único (como DNI, usuario) o restricción
        // de clave foránea.
        model.addAttribute("errorGlobal",
                "La operación no se pudo completar porque entra en conflicto con datos existentes (ej. el registro ya existe o está asociado a otros datos).");
